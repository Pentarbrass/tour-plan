        ...
        <div class="container">
            <div class="footer-wrapper">
                ...
                <div class="footer__rights">
                    <ul class="footer__ul footer__rights-ul">
                        <li class="footer__item footer__rights-item"><a href="#" class="footer__link">Disclaimer</a>
                        </li>
                        <li class="footer__item footer__rights-item"><a href="#" class="footer__link">Conditions of
                                use</a></li>
